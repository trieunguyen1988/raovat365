...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{!!URL::asset('public/admin/plugins/iCheck/square/blue.css')!!}">
  ...
  <body class="hold-transition login-page">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="{!!URL::asset('public/admin/plugins/jQuery/jQuery-2.1.4.min.js')!!}"></script>
    <!-- Bootstrap 3.3.5 -->
